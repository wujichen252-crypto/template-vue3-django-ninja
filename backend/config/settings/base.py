...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'template_db'),
...
# JWT Settings
JWT_SECRET = os.getenv('JWT_SECRET', 'your-256-bit-secret-key-here')
JWT_ACCESS_EXPIRE_MINUTES = int(os.getenv('JWT_ACCESS_EXPIRE_MINUTES', '120'))
